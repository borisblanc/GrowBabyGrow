package com.app.babygrow.Classes.Bigflake;
...
public class EncodeDecodeTest extends AndroidTestCase {
     ...
     */
    private void doEncodeDecodeVideoFromSurfaceToSurface(MediaCodec encoder, InputSurface inputSurface, int encoderColorFormat, MediaCodec decoder, OutputSurface outputSurface) {
        final int TIMEOUT_USEC = 10000;
        ByteBuffer[] encoderOutputBuffers = encoder.getOutputBuffers();
